import 'package:p1/screens/driverscreen/edit_drprofile.dart';
...
class DrprofileView extends StatefulWidget {
  const DrprofileView({Key? key}) : super(key: key);

  @override
  _ProfileViewState createState() => _ProfileViewState();
}

class _ProfileViewState extends State<DrprofileView> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>DrprofileScreen()));
                    },
                  ),
                ),
              ],
