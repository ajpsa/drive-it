...
int price;
CarDetail(this.path, this.name,this.price,this.brand, this.gear,this.color, this.fuel,this.coid,this.id);
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> CarBooking(path,name,price,brand,gear,color,fuel,coid,id)));
              },
              child: Text(
                'Book Now',
