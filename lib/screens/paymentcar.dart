...
import 'package:p1/screens/paymentcarfinal.dart';
import 'package:razorpay_flutter/razorpay_flutter.dart';


class PaymentCarPage extends StatefulWidget {

  @override
  _PaymentCarPageState createState() => _PaymentCarPageState();
}

class _PaymentCarPageState extends State<PaymentCarPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: userref.where('email', isEqualTo: _user?.email).where(
              "status", isEqualTo: "pending").snapshots(),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context) => PaymentCarFinal(pic,did,car,cid,name,address,phone,email,fd,td,date,ppd,admincost,overallcosts)));
                              //complete(id);
                            }
                            ),
                            SizedBox(height: 15),
