...
class Viewdriversblocked extends StatefulWidget {
  const Viewdriversblocked({Key? key}) : super(key: key);


  @override
  _ViewdriversblockedState createState() => _ViewdriversblockedState();
}

class _ViewdriversblockedState extends State<Viewdriversblocked> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Drivers Blocked",textAlign: TextAlign.center),
      ),
      body: Container(
        ...
        child: StreamBuilder(
          stream: userref.where('role',isEqualTo: 'Driver').where('status',isEqualTo: 'Blocked').snapshots(),
