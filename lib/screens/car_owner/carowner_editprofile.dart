...
import 'carowner_drawer.dart';

class coeditprofileScreen extends StatefulWidget {
  const coeditprofileScreen({Key? key}) : super(key: key);

  @override
  _coeditprofileScreenState createState() => _coeditprofileScreenState();
}

class _coeditprofileScreenState extends State<coeditprofileScreen> {
  ...
  void update() async {
    try {
      ...
      Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>CarownprofileView()));
    } catch(e){}
  }
  @override
