...
import 'carowner_editprofile.dart';


class CarownprofileView extends StatefulWidget {
  const CarownprofileView({Key? key}) : super(key: key);

  @override
  _CarownprofileViewState createState() => _CarownprofileViewState();
}

class _CarownprofileViewState extends State<CarownprofileView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Car Owner Profile",textAlign: TextAlign.center),
      ),
      body: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>coeditprofileScreen()));
                    },
                  ),
                ),
              ],
